      ...
      <Container className='d-flex'>
        ...
        <div style={{ width: "50%" }}>
          ...
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />1.37%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
          ...
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />4.69%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />7.46%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />10.63%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />14.87%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />19.32%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />23.86%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
