      ...
      <Container className='d-flex'>
        ...
        <div style={{ width: "50%" }}>
          ...
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#FF0000" }}><TbArrowBigDownLinesFilled />3.87%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />7.93%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#FF0000" }}><TbArrowBigDownLinesFilled />7.1%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
          ...
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />6.8%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
          ...
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />19.6%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />30.67%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
