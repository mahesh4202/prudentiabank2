      ...
      <Container className='d-flex'>
        ...
        <div style={{ width: "50%" }}>
          ...
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#FF0000" }}><TbArrowBigDownLinesFilled />6.97%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#FF0000" }}><TbArrowBigDownLinesFilled />10.76%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
          ...
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />6.98%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />10.78%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />28.91%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />36.87%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
