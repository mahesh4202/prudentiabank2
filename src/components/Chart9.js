      ...
      <Container className='d-flex'>
        ...
        <div style={{ width: "50%" }}>
          ...
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />3.87%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />4.97%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />6.99%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />8.34%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />10.75%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />15.87%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />20.45%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
          <div className='d-flex'>
            ...
            <div style={{ width: "40%" , textAlign: "center" , borderRight: "1px solid" , fontSize: "16px" ,}}><span style={{ color: "#00BE00" }}><TbArrowBigUpLinesFilled />24.97%</span></div>
          </div>
          <div style={{ borderBottom: "1px solid" }}></div>
